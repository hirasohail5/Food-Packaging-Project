...
const BannerCom = () => {
  return (
    <section className="relative w-full h-[85vh] min-h-[550px] max-h-[900px] overflow-hidden font-saans">
      ...
      {/* Content Container - Fixed Left Guide Line Axis */}
      <div className="absolute inset-0 flex flex-col justify-end pb-8 sm:pb-12 px-5 sm:px-10 lg:pl-[245px] lg:pr-12 pointer-events-none">
        <div className="max-w-[580px] pointer-events-auto">
